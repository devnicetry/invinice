...
@InputType()
class WedInvGalleryCreateNestedManyWithoutWedInvsInput {
...
export { WedInvGalleryCreateNestedManyWithoutWedInvsInput as WedInvGalleryCreateNestedManyWithoutWedInvsInput };
