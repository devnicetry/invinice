...
@InputType()
class WedInvGiftCreateNestedManyWithoutWedInvsInput {
...
export { WedInvGiftCreateNestedManyWithoutWedInvsInput as WedInvGiftCreateNestedManyWithoutWedInvsInput };
